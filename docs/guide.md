...
Log into [`app.ctrader.com`](https://app.ctrader.com/) or the broker's own domain (for
this account, [`ct.axiory.com`](https://ct.axiory.com/)) with the account's cTID and open
the position:
